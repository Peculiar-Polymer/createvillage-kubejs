...
When the server was reset, a separate modpack was created for it (CreateVillage Repaved). At some point, the generator script (`mixer_cobble_gen.js`) was added to the server.
