...
This repository contains KubeJS scripts that I've written for use in [CreateVillage](https://www.curseforge.com/minecraft/modpacks/createvillage) - a Minecraft modpack. It's not officially associated with the pack, and at the time of writing none of the scripts in here have made it into the pack itself.
